...
path = '/home/jgodoy/Documentos/Datos_bajados_scraping/Radar_AEMET/'
...
mydb = MySQLdb.connect(host = 'localhost', user = "root", passwd ='lab202', db='radar_aemet')
...
for i in lstFechas:
    ...
    print fecha_str
    #query = "INSERT INTO radar_aemet VALUES('" + fecha_str+"'"+", '/home/jgodoy/Documents/Radar_AEMET/"+nombre+".gif');"
    try:
        query = "INSERT INTO radar_aemet VALUES('" + fecha_str + "'" + ", '/home/jgodoy/Documentos/Datos_bajados_scraping/Radar_AEMET/" + nombre + ".gif');"
        print query
...
#mv *.gif /home/jgodoy/Documents/Radar_AEMET/
